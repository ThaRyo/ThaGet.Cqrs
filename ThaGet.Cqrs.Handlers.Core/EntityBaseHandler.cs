...
{
    public abstract class EntityBaseHandler<TCommand, TResponse, TEntity, TId> : BaseHandler<TCommand, TResponse>
        ...
        where TId : struct
    {
        ...
        protected EntityBaseHandler(ILogger<object> logger, IMapper mapper, IRepository<TEntity, TId> repository) : base(logger)
        {
            Mapper = mapper;
