...
{
    public abstract class DeleteEntityHandler<TCommand, TResponse, TEntity, TId>
        : CommandEntityHandler<TCommand, TResponse, TEntity, TId>
        where TCommand : DeleteEntityCommand<TId, TResponse>
